...
CircleProgressBar.prototype.init = function(options) {
	...
	//canvas 宽高
	var user_see_r = this.resultOptions.r;
	var user_see_lineWidth = this.resultOptions.lineWidth;
	this.canvasWidth = this.canvasHeight = user_see_r * 2 + user_see_lineWidth * 2;
	// 线条宽度有一半是属于半径的，所以此处要加上线条宽度的一半
	this.r = this.resultOptions.r + this.lineWidth / 2;
	// 线条宽度有一半是属于半径的，另外一半超出了canvas，不显示， 所以此处要加上线条宽度的一半
